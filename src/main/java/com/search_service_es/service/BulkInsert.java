...
public class BulkInsert implements bulk_insert {
    ...
    @Override
    public HttpStatus ingestdata(List<SearchDevice> device) throws InterruptedException, IOException {

        BulkProcessor.Listener listener = new BulkProcessor.Listener() {

            @Override
            public void beforeBulk(long l, BulkRequest bulkRequest) {
             System.out.print("Updating Started");
            }
                ...
                if (bulkResponse.hasFailures()) {
                    for (BulkItemResponse bulkItemResponse : bulkResponse) {
                        if (bulkItemResponse.isFailed()) {
                            ...
                            System.out.print(bulkItemResponse.getFailure());
                        }
                    }
                }
            ...
            public void afterBulk(long l, BulkRequest bulkRequest, Throwable throwable) {
                System.out.print(bulkRequest.getDescription());
            }
        };
        ...
        try {
            ...
            device.forEach(emp -> {
                ...
                IndexRequest indexRequest = new IndexRequest("device_index", "_doc", emp.getId().toString()).
                        source(builder);
                UpdateRequest updateRequest = new UpdateRequest("device_index", "_doc", emp.getId().toString());
